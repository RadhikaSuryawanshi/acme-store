...
export default function Shirts() {
  ...
  const Groceries =
    data.filter((product: any) => product.category === "groceries") || [];
  const sortedProducts = [...Groceries].sort((a: any, b: any) => {
    switch (sortBy) {
      case "trending":
  ...
  const handleSort = (value: string) => {
    setSortBy(value);
    if (value === "relevance") {
      router.push("/search/groceries");
    } else {
      router.push(`/search/groceries?sort=${value}`);
    }
  };
